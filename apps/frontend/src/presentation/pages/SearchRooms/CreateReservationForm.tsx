...
export const CreateReservationForm = ({
  ...
  const calculateTotalPrice = () => {
    ...
    return nights * room.pricePerNight.amount; // ✅ Cambiado aquí
  };
    ...
    <div className="reservation-form">
      <div className="reservation-summary">
        ...
        <div className="reservation-summary-item">
          ...
          <strong>
            {room.pricePerNight.currency} ${room.pricePerNight.amount.toFixed(2)} {/* ✅ Cambiado aquí */}
          </strong>
        </div>
        <div className="reservation-summary-total">
          <span>Total:</span>
          <strong>
            {room.pricePerNight.currency} ${calculateTotalPrice().toFixed(2)} {/* ✅ Cambiado aquí también */}
          </strong>
        </div>
      </div>
