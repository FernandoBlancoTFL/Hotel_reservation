...
describe('CheckInReservation Use Case', () => {
  ...
  it('should check in a confirmed reservation', async () => {
    ...
    const checkedIn = await checkInReservation.execute({
  ...
  it('should throw error if reservation not found', async () => {
    ...
    await expect(checkInReservation.execute({
  ...
  it('should throw error if user does not have permission', async () => {
    ...
    await expect(checkInReservation.execute({
      reservationId: reservation.id,
      userId: guest.id
    })).rejects.toThrow('User does not have permission to check in reservations');
  });
